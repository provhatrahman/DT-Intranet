...
// useDisplaySettingsStore, and volume/sound-toggle/TTS settings live in
// useAudioSettingsStore (both extracted from this store, mirroring MAIN's
// upstream split). See those modules for the migration read from this
// store's old "ryos:app-store" localStorage blob.
