...
export function MacTopMenuBar({ children }: MacTopMenuBarProps) {
  ...
  // This build has no separate "show resizers" debug sub-toggle — the single
  // `debugMode` flag drives both.
  ...
  const needsTrafficLightClearance =
    isDesktopApp && !isWindowsPlatform && !isFullscreen && isMacOSTheme;
      ...
      style={{
        ...
        backgroundImage: isAquaGlass
          ...
          : isMacOSTheme
            ...
            : undefined,
        backdropFilter: isAquaGlass ? undefined : isMacOSTheme ? "blur(20px)" : undefined,
    ...
    >
      ...
      {isDesktopApp && (
        <div
          ...
          style={{
            ...dragRegionStyle,
            background: showDesktopDragDebugZone ? "rgba(255, 0, 0, 0.3)" : undefined,
            minHeight: "100%",
          }}
          onMouseDown={async (e) => {
            ...
            try {
              ...
              // Not running inside Tauri (or the API isn't available) — no-op.
            }
          }}
        />
      )}
