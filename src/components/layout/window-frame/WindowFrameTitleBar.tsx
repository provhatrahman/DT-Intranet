...
export function WindowFrameTitleBar({
  ...
  return isWindowsTheme ? (
    ...
    >
      <div
        className={cn("title-bar-text min-w-0", !isForeground && "inactive")}
        style={{
          display: "flex",
          alignItems: "center",
          overflow: "hidden",
      ...
      <div
        className="title-bar-controls flex items-center gap-0.5"
    ...
    >
      <div
        ...
        data-titlebar-controls
      >
        <div className="absolute inset-0 -m-2" /> {/* Larger click area */}
        <div
          className={`size-4 ${
            !isTransparent &&
