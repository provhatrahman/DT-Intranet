...
function WindowsTaskbarWithState({
  ...
  const instances = useMemo(
    ...
    // The signature string is a deliberate cache key: the snapshot is rebuilt
    // only when a taskbar-relevant field changes, not on every geometry/focus
    // write to the instances map.
